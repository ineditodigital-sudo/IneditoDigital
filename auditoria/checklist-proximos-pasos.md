...
- [x] ~~**Decidir qué hacer con los servicios que la gente busca y no existen**~~ — **Decidido el 26/08: no se ofrecen.** Producción audiovisual (813 impresiones, 15 clics) y espacios publicitarios / Feria de San Marcos (1.452 impresiones) quedan **fuera del catálogo**. Las URLs antiguas siguen redirigiendo a `/servicios`, que es lo más honesto sin prometer algo que no está. Apps y redes sociales, igual — SRV-01
