    ...
    return [
        ...
        'apariencia' => [
            ...
            'campos' => [
                ...
                'topo_estilo' => ['label' => 'Cómo se dibujan', 'tipo' => 'lista', 'def' => 'video',
                                  'opciones' => ['video' => 'La animación original (458 KB)',
                                                 'canvas' => 'Dibujadas al vuelo (no pesan nada)'],
                                  'ayuda' => 'La animación original se ve idéntica al diseño; las dibujadas se generan solas y no gastan datos. En una tarjeta que se abre con el celular en la calle, eso se nota.'],
