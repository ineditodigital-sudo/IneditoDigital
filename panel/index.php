...
$allowed = ['dashboard','analiticas','reportes','leads','contenido','presentacion','clientes','resenas','paginas','nueva','miembros','buscadores','blog','servicios','portafolio','seo','ajustes'];
