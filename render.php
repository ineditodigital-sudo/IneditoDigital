...
try {
  ...
  foreach ($pdo->query("SELECT slug, nombre, tipo, contenido, seo_title, seo_desc, seo_image, ruta, en_menu FROM pages WHERE status='published' AND tipo <> 'presentacion'") as $r) {
