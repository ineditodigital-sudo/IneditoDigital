...
['/glosario','0.7','monthly'],['/nosotros','0.6','monthly'],['/contacto','0.7','monthly'],['/privacidad','0.3','yearly'],['/terminos','0.3','yearly']];
try { $pdo=db_connect($cfg);
  ...
  // Las páginas de contacto del equipo: son la base de la autoría (IDX-04)
  foreach($pdo->query("SELECT ruta FROM pages WHERE tipo='miembro' AND status='published'") as $r) $urls[]=[$r['ruta'],'0.6','monthly'];
} catch (Throwable $e) {}
