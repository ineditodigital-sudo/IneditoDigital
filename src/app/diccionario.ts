...
export const DICCIONARIO: Record<string, string> = {
  ...
  /* «Arma tu ruta» en las fichas de servicio (23-sep) */
  'Según tu punto de partida': 'Depending on where you start',
  'ARMA': 'BUILD',
  'TU RUTA': 'YOUR PATH',
  'Lo que conviene antes, junto o en lugar de este servicio, según cómo está tu negocio hoy.': 'What\'s worth doing before, alongside or instead of this service, depending on where your business is today.',
  '¿Cómo está tu negocio hoy?': 'Where is your business today?',
  'Empiezo de cero': 'I\'m starting from scratch',
  'Ya tengo un negocio': 'I already have a business',
  'Primero': 'First',
  'Va con este': 'Goes with this',
  'Más alcance': 'More reach',
  'Después': 'Next',
  'Otra ruta': 'Another route',
  'Ver el servicio': 'See the service',
  'Antes del sitio, un logo que haga ver formal a tu negocio.': 'Before the website, a logo that makes your business look professional.',
  'Antes de rehacer tu sitio, saber con evidencia qué está fallando.': 'Before rebuilding your site, find out with evidence what\'s failing.',
  'Que tu negocio aparezca en Google Maps desde el primer día.': 'Get your business on Google Maps from day one.',
  'Que el sitio no solo exista: que aparezca cuando te buscan.': 'A site that doesn\'t just exist: it shows up when people search for you.',
  'Si vendes con anuncios, una página hecha solo para convertir.': 'If you sell with ads, a page built only to convert.',
  'Para aparecer en Google primero hace falta un sitio rápido y bien hecho.': 'To show up on Google, you first need a fast, well-built site.',
  'Saber por qué hoy no apareces antes de invertir en posicionarte.': 'Find out why you don\'t show up today before investing in rankings.',
  'Si atiendes en tu ciudad, la ficha pesa tanto como el sitio.': 'If you serve your city, your Business Profile matters as much as your site.',
  'Aparecer también cuando le preguntan a ChatGPT o a Gemini.': 'Show up when people ask ChatGPT or Gemini, too.',
  'Si necesitas clientes esta semana, los anuncios dan resultados mientras el posicionamiento madura.': 'If you need customers this week, ads deliver while your rankings mature.',
  'Las IA recomiendan lo que pueden leer: primero, un sitio claro.': 'AI recommends what it can read: first, a clear website.',
  'Primero, saber qué dicen hoy las IA de tu negocio.': 'First, find out what AI says about your business today.',
  'Los asistentes se apoyan en lo que Google ya sabe de ti.': 'Assistants lean on what Google already knows about you.',
  'Tu ficha de Google es de lo primero que leen los asistentes.': 'Your Google Business Profile is one of the first things assistants read.',
  'Si quieres aparecer en ChatGPT desde ya, sin esperar a que te recomiende.': 'If you want to appear in ChatGPT right now, without waiting to be recommended.',
  'Una ficha que lleva a tu propio sitio convence más que una sin enlace.': 'A profile that links to your own site is more convincing than one without a link.',
  'Saber qué ven hoy de ti en Google antes de corregir.': 'Find out what people see about you on Google before fixing anything.',
  'La ficha te pone en el mapa; el posicionamiento, en los resultados.': 'Your profile puts you on the map; rankings put you in the results.',
  'Quien te encuentra en Maps te escribe: que nunca se quede sin respuesta.': 'Whoever finds you on Maps writes to you: make sure they always get an answer.',
  'Para que te escriban, primero te tienen que encontrar.': 'For people to write to you, they first have to find you.',
  'El agente contesta; la IA de ventas le da seguimiento a quien no compró.': 'The agent answers; sales AI follows up with whoever didn\'t buy.',
  'Ver cuántos te escriben y de dónde llegan.': 'See how many write to you and where they come from.',
  'Más conversaciones: anuncios que llevan directo a tu WhatsApp.': 'More conversations: ads that lead straight to your WhatsApp.',
  'Primero, que cada mensaje reciba respuesta; después, el seguimiento.': 'First, every message gets an answer; then comes the follow-up.',
  'Ver cuántos prospectos llegan, de dónde y a qué costo.': 'See how many leads come in, from where and at what cost.',
  'Más prospectos que calificar: un embudo que los trae de tus anuncios.': 'More leads to qualify: a funnel that brings them in from your ads.',
  'Un funnel convence más cuando la marca se ve formal.': 'A funnel is more convincing when the brand looks professional.',
  'El funnel convierte; los anuncios le traen gente.': 'The funnel converts; ads bring people to it.',
  'Que cada prospecto del funnel reciba respuesta al momento.': 'Every lead from the funnel gets an answer right away.',
  'Otra fuente de tráfico: donde tu cliente ya está preguntando.': 'Another source of traffic: where your customer is already asking.',
  'Sin una página que convierta, cada clic se pierde.': 'Without a page that converts, every click is lost.',
  'Que cada persona que escribe por el anuncio reciba respuesta.': 'Everyone who writes in from the ad gets an answer.',
  'Saber qué campaña te trae prospectos, no solo clics.': 'Know which campaign brings you leads, not just clicks.',
  'Anunciarte donde tu cliente pregunta, no solo donde busca.': 'Advertise where your customer asks, not only where they search.',
  'Un lugar adonde llevar a quien da clic en tu anuncio.': 'A place to send whoever clicks your ad.',
  'Aparecer pagado hoy, mientras trabajas para que te recomienden.': 'Appear as a paid result today, while you work on getting recommended.',
  'Medir cuántos prospectos te trae ChatGPT, igual que tus otros canales.': 'Measure how many leads ChatGPT brings you, just like your other channels.',
  'Si tu cliente todavía busca en Google, empieza por ahí.': 'If your customer still searches on Google, start there.',
  'Tu canal propio antes que los marketplaces: un sitio que venda.': 'Your own channel before marketplaces: a website that sells.',
  'Antes de abrir canales nuevos, saber cómo está hoy tu presencia digital.': 'Before opening new channels, find out where your digital presence stands today.',
  'Medir cuántos contactos trae cada canal y a qué costo.': 'Measure how many contacts each channel brings and at what cost.',
  'Invertir en el canal que la estrategia eligió.': 'Invest in the channel the strategy chose.',
  'Algo que medir desde el día uno: un sitio con la analítica bien puesta.': 'Something to measure from day one: a site with analytics set up properly.',
  'Qué medir empieza por saber qué está fallando.': 'Knowing what to measure starts with knowing what\'s failing.',
  'Campañas que se juzgan por los prospectos que traen.': 'Campaigns judged by the leads they bring in.',
  'Decidir con datos en qué canal crecer.': 'Decide with data which channel to grow in.',
  'Si empiezas de cero, no hay mucho que diagnosticar: empieza por tu sitio.': 'If you\'re starting from scratch, there isn\'t much to diagnose: start with your website.',
  'Tu ficha de Google es lo más rápido para empezar a aparecer.': 'Your Google Business Profile is the fastest way to start showing up.',
  'Si todavía no tienes marca, empieza por un logo.': 'If you don\'t have a brand yet, start with a logo.',
  'Si el diagnóstico dice que no te encuentran: posicionamiento en Google.': 'If the diagnosis says people can\'t find you: Google rankings.',
  'Si dice que se pierden mensajes: un agente que conteste a toda hora.': 'If it says messages are getting lost: an agent that answers around the clock.',
  'Si dice que no sabes qué funciona: tus números en un tablero.': 'If it says you don\'t know what works: your numbers on a dashboard.',
  'El logo es el punto de partida de la identidad.': 'The logo is the starting point of your identity.',
  'Tarjetas que ya llevan tu marca nueva.': 'Cards that already carry your new brand.',
  'Que el perfil de tu empresa refleje la marca.': 'Make your company profile reflect the brand.',
  'Llevar tu marca a un sitio que venda.': 'Take your brand to a website that sells.',
  'Renovar tu sitio con la marca nueva.': 'Refresh your website with the new brand.',
  'Llevar la marca a la calle, donde la ve más gente.': 'Take the brand to the street, where more people see it.',
  'Antes del QR, un logo que lo acompañe.': 'Before the QR code, a logo to go with it.',
  'Tu contacto en una tarjeta que se comparte con un toque.': 'Your contact details on a card you share with a tap.',
  'Un QR que lleva a dejarte una opinión en Google.': 'A QR code that leads people to leave you a Google review.',
  'QR en tu stand para no perder a nadie que se acerque.': 'QR codes at your booth so you don\'t lose anyone who stops by.',
  'El logo es el inicio; el branding lo vuelve una identidad completa.': 'The logo is the start; branding turns it into a complete identity.',
  'Tarjetas con tu logo que se comparten con un toque.': 'Cards with your logo, shared with a tap.',
  'Actualizar el perfil de tu empresa con el logo nuevo.': 'Update your company profile with the new logo.',
  'Tu marca nueva, en un sitio donde te encuentren.': 'Your new brand, on a website where people find you.',
  'Renovar el sitio con el logo nuevo.': 'Refresh the website with the new logo.',
  'Un stand convence más con una marca que se vea formal.': 'A booth is more convincing with a brand that looks professional.',
  'Que cada visitante del stand se lleve tu información.': 'Every booth visitor leaves with your information.',
  'Tu contacto en un toque, sin tarjetas de papel.': 'Your contact details with a tap, no paper cards.',
  'Dar seguimiento a todos los contactos que dejó la expo.': 'Follow up on every contact the expo left you.',
  'Una tarjeta con tu logo, no con uno genérico.': 'A card with your logo, not a generic one.',
  'Que el perfil al que llevas esté a la altura.': 'Make sure the profile you lead to lives up to it.',
  'Para quien no acerca el celular: el mismo contacto en un QR.': 'For those who don\'t tap their phone: the same contact in a QR code.',
  'En una expo, cada tarjeta que compartes es un prospecto.': 'At an expo, every card you share is a lead.',
  'El perfil lleva a tu sitio: que esté a la altura.': 'The profile leads to your website: make sure it lives up to it.',
  'Si vendes a otras empresas, ordenar LinkedIn junto con tus otros canales.': 'If you sell to other businesses, plan LinkedIn alongside your other channels.',
  'Tu contacto y tu perfil en una tarjeta que se comparte con un toque.': 'Your contact details and profile on a card you share with a tap.',
  'Antes de un espectacular, una marca que se recuerde.': 'Before a billboard, a brand people remember.',
  'Quien ve tu espectacular te busca en Maps: que te encuentre.': 'Whoever sees your billboard looks you up on Maps: make sure they find you.',
  'Ver si suben las búsquedas y los contactos mientras el espectacular está arriba.': 'See whether searches and contacts go up while the billboard is up.',
  'Si prefieres pagar solo cuando alguien da clic, anuncios en Google.': 'If you\'d rather pay only when someone clicks, Google ads.',
  'La versión para WhatsApp: atiende ahí y le pasa el prospecto a tu equipo.': 'The WhatsApp version: it answers there and hands the lead to your team.',
  'Que al prospecto que atendió el agente se le dé seguimiento.': 'Make sure the lead the agent handled gets followed up.',
  'Más conversaciones: un funnel que te las trae.': 'More conversations: a funnel that brings them to you.',
  'Empieza por saber qué dicen hoy de tu negocio Google y las IA.': 'Start by finding out what Google and AI say about your business today.',
  'Que ChatGPT y Gemini te recomienden.': 'Get recommended by ChatGPT and Gemini.',
  'Un agente que atienda tu WhatsApp a toda hora.': 'An agent that handles your WhatsApp around the clock.',
  'Para optimizar con IA, primero tus números en un solo lugar.': 'To optimize with AI, first get your numbers in one place.',
  'Campañas en Google que se ajustan con datos reales.': 'Google campaigns that adjust with real data.',
  'Llevar tus anuncios también a ChatGPT.': 'Take your ads to ChatGPT, too.',
  'Antes de optimizar la tienda, decidir por dónde vender.': 'Before optimizing the store, decide where to sell.',
  'Un embudo para que las visitas terminen en compra.': 'A funnel so visits end in a purchase.',
  'Más visitas a tu tienda, con campañas medidas.': 'More visits to your store, with measured campaigns.',
};
